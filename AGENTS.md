...
- [`master/01-product.md`](docs/specs/master/01-product.md): vision, goals and non-goals
...
| Area                                              | Spec file                                                                               |
| ------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Scope: is this feature in or out?                 | [01](docs/specs/master/01-product.md) §4 and [13](docs/specs/master/13-delivery.md) §45 |
...
Conventional Commits with why-over-what and no AI attribution). It only produces the
message. It does not stage files or run `git commit`.
...
formatting problem: split along real seams, with one responsibility per file, rather than
...
density, error handling and idiom. Code you add should read like the
...
| Punctuation                            | Em dashes and Oxford commas are forbidden in all new or edited prose, comments, documentation and commit messages. |
...
1. It matches the agreed intent. No unresolved ambiguity is silently assumed away.
